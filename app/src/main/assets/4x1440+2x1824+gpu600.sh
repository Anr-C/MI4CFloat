...
echo 65 > /sys/devices/system/cpu/cpu0/cpufreq/ondemand/up_threshold_multi_core
echo 2 > /sys/devices/system/cpu/cpu0/cpufreq/ondemand/down_differential_multi_core
echo 1248000 > /sys/devices/system/cpu/cpu0/cpufreq/ondemand/optimal_freq
echo 960000 > /sys/devices/system/cpu/cpu0/cpufreq/ondemand/sync_freq
echo 65 > /sys/devices/system/cpu/cpu0/cpufreq/ondemand/up_threshold_any_cpu_load
...
echo 20000 > /sys/devices/system/cpu/cpu4/cpufreq/ondemand/sampling_rate
...
echo 70 > /sys/devices/system/cpu/cpu4/cpufreq/ondemand/up_threshold_multi_core
echo 3 > /sys/devices/system/cpu/cpu4/cpufreq/ondemand/down_differential_multi_core
echo 960000 > /sys/devices/system/cpu/cpu4/cpufreq/ondemand/optimal_freq
echo 750000 > /sys/devices/system/cpu/cpu4/cpufreq/ondemand/sync_freq
echo 80 > /sys/devices/system/cpu/cpu4/cpufreq/ondemand/up_threshold_any_cpu_load
echo 384000 > /sys/devices/system/cpu/cpu4/cpufreq/scaling_min_freq
echo 1824000 > /sys/devices/system/cpu/cpu4/cpufreq/scaling_max_freq
echo 1824000 > /sys/devices/system/cpu/cpu4/cpufreq/cpuinfo_max_freq
