...
echo 75 > /sys/devices/system/cpu/cpu0/cpufreq/ondemand/up_threshold_multi_core
echo 5 > /sys/devices/system/cpu/cpu0/cpufreq/ondemand/down_differential_multi_core
echo 460000 > /sys/devices/system/cpu/cpu0/cpufreq/ondemand/optimal_freq
echo 384000 > /sys/devices/system/cpu/cpu0/cpufreq/ondemand/sync_freq
echo 85 > /sys/devices/system/cpu/cpu0/cpufreq/ondemand/up_threshold_any_cpu_load
echo 384000 > /sys/devices/system/cpu/cpu0/cpufreq/scaling_min_freq
echo 600000 > /sys/devices/system/cpu/cpu0/cpufreq/scaling_max_freq

# configure governor settings for big cluster
echo "ondemand" > /sys/devices/system/cpu/cpu4/cpufreq/scaling_governor
echo 80000 > /sys/devices/system/cpu/cpu4/cpufreq/ondemand/sampling_rate
...
echo 90 > /sys/devices/system/cpu/cpu4/cpufreq/ondemand/up_threshold_multi_core
echo 10 > /sys/devices/system/cpu/cpu4/cpufreq/ondemand/down_differential_multi_core
echo 640000 > /sys/devices/system/cpu/cpu4/cpufreq/ondemand/optimal_freq
echo 640000 > /sys/devices/system/cpu/cpu4/cpufreq/ondemand/sync_freq
echo 75 > /sys/devices/system/cpu/cpu4/cpufreq/ondemand/up_threshold_any_cpu_load
...
# 禁用核心
echo 60 > /sys/module/msm_thermal/core_control/cpus_offlined
