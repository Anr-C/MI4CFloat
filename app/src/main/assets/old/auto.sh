...
echo 640000 > /sys/devices/system/cpu/cpu0/cpufreq/ondemand/sync_freq
echo 70 > /sys/devices/system/cpu/cpu0/cpufreq/ondemand/up_threshold_any_cpu_load
...
echo 40000 > /sys/devices/system/cpu/cpu4/cpufreq/ondemand/sampling_rate
...
echo 0 60 60 60 > /sys/devices/system/cpu/cpu0/core_ctl/busy_up_thres
echo 0 30 30 30 > /sys/devices/system/cpu/cpu0/core_ctl/busy_down_thres
